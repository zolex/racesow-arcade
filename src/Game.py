...
class Game(GameScene):
    ...
    def __init__(self, map: str, surface: pygame.Surface, clock: pygame.time.Clock, settings: Settings = None):
        ...
        self.font = pygame.font.Font(font_path, int(8 * scale))
        self.font_small = pygame.font.Font(font_path, int(6 * scale))
        self.font_big = pygame.font.Font(font_path, int(12 * scale))
